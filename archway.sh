...
if [ ! $ARCHWAY_NODENAME ]; then
	read -p "Укажите имя ноды (без спецсимволов - только буквы и цифры): " ARCHWAY_NODENAME
fi
sleep 1
...
echo "Нода $ARCHWAY_NODENAME успешно установлена"
echo "####################################"